...
namespace Vcyber.BLMS.Application
{
    ...
    /// 日志操作
    /// </summary>
    public interface ILogOperatorApp
    {
        #region ==== 公共方法 ====
        ...
        /// <param name="type">日志类型</param>
        /// <returns></returns>
        IEnumerable<OperatorLog> GetLogInfo(string sourceId, string mallCode, ELogType type);
        ...
        /// <returns></returns>
        IEnumerable<OperatorLog> GetLogInfo(string sourceId, string mallCode, ELogType type, int pageIndex, int pageSize, out int totalCount);
        ...
        /// <returns></returns>
        IEnumerable<OperatorLog> GetLogInfo(LogSearchParamater para, out int totalCount);
