...
{
    public interface IDealerMembershipStorager
    {
        bool AddMembershipDealerRecord(string membershipId, string dealerId);
        void AddPaperworkToMembership_Schedule(UserModel user);
        ...
        IEnumerable<MemberSonata> SelectMemberListNoJoin(string custName, string phoneNumber, string identityNumber, string vin, string dealerId, string startTime, string endTime, int pageIndex, int pageSize, out int totalCount);
        ...
        bool IsPersonalUser(string idNumber);
         ...
         bool IsComUser(string idNumber);
