...
systemManage.controller('UserManagmentCtrl', function ($scope, $http, $routeParams) {
    ...
    //加载用户类型列表
    $http.post('/Roles/RoleList?start=0&count=100').success(function (largeLoad) {
...
//会员创建渠道管理
//GetCreatedPersonCtrl

systemManage.controller('GetCreatedPersonCtrl', function ($scope, $http, $routeParams, $location) {
    $scope.Functions = {};
    $scope.AddFunctionData = {};
    $scope.EditFunctionData = {};
    $scope.routeDw = { select: 0 };
