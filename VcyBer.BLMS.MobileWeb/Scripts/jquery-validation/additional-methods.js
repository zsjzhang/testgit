...
(function (factory) {
    ...
    */
    ...
    $.validator.addMethod("IDCardCN", function (value, element) {
        var paper_work = $("#PaperWork").val();
        var flag = true;
        if (paper_work == "1") {
            var verIdCard = VerifyTheIdentityCardNumber(value);
            flag = verIdCard == "验证通过!";
        }
        else if (paper_work == "2") {
            flag = /^[a-zA-Z0-9]{3,21}$|^(P\d{7})|(G\d{8})$/.test(value);
        }
        else if (paper_work == "3") {
    ...
    $.validator.addMethod("pwd", function (value, element, param) {
        return this.optional(element) || /^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])[a-zA-Z0-9]{8,12}$/.test(value);
        //return this.optional(element) || /^(([A-Z]+[a-z]+[0-9]+)|([A-Z]+[0-9]+[a-z]+)|([a-z]+[A-Z]+[0-9]+)|([a-z]+[0-9]+[A-Z]+)|([0-9]+[a-z]+[A-Z]+)|([0-9]+[A-Z]+[a-z]+))[A-Za-z0-9]*$/.test(value);
        // return this.optional(element) || /^(?!\D+$)(?![a-z]+$)(?![^A-Z]+$)\S{6,12}$/.test(value);
...
function VerifyTheIdentityCardNumber(idcard) {
