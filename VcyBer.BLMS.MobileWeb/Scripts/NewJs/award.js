	...
	var rotateFn = function (awards, angles, txt){
		...
		$('#rotate').rotate({
			...
			callback:function (){
				/*console.log(awards)*/
				clearTimeout(timer1)
				var  noaward1='<div class="result_bg"></div><div class="noaward"><div class="awardb"><p></p><a href="BlueMembers_lucky_address.html" id="btn" target="_self">请填写邮寄地址</a></div></div>';
	...
	var rotateSelect=function (){
		...
		switch (item) {
			case 0:
				...
				break;
			case 1:
				rotateFn(1, 90, '恭喜您，抽中usb充电器一个，奖品稍后（活动结束后10个工作日内）会统一安排邮寄，请保持手机畅通！');
				break;
			case 2:
				rotateFn(2, 180, '不好意思，离奖品只差一步哦！');
				break;
			case 3:
				rotateFn(3, 270, '恭喜您，抽中卡片移动电源一个，奖品稍后（活动结束后10个工作日内）会统一安排邮寄，请保持手机畅通！');
				break;
		}
