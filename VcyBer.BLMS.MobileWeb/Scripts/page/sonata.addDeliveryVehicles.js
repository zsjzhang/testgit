var SonataAddDeliveryVehiclesScripts = function () {
    ...
    function setDealer() {
        ...
        $("#DealerCity").val(city);
        common.post(common.api("Sonata/TwoPoints"), {
            province:province,
            city:city,
            long1:$("#TakeLong").val(),
            lat1:$("#TakeLat").val(),
    ...
    function submitForm() {
        ...
        common.post(common.api("Sonata/APIAddDeliveryVehicles"), requestData, function (result) {
