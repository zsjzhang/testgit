var ActivationSonataSetp1 = function () {
    var mapObj;
    var city;
    var province;
    ...
    function bindCity(province) {
        common.post(common.api("PageApi/City"), { province: province }, function (result) {
            $("#DealerCity").append("<option value=\"\">请选择</option>");
    ...
    function submitForm() {
        ...
        location.href = common.resolveUrl(common.api("UserCenter/ActivationSonataSetp2", { DealerId: $("#DealerId").val() }));
    }
}();