...
namespace Vcyber.BLMS.Common
{
    public class CookieHelper
    {
        ...
        public static void SetNewCookie(string key, string value)
        {
            SetNewCookie(key, null, value, null);
        }
        ...
        public static void SetNewCookie(string cookieName, string key, string value, DateTime? expires)
        {
            HttpResponse response = HttpContext.Current.Response;
            if (response != null)
            {
