...
namespace Vcyber.BLMS.Entity.SelectCondition
{
    ...
    /// 用户经验检索条件
    /// </summary>
    public class UserEmpiricCondition
    {
       #region ==== 私有字段 ====
        ...
        public UserEmpiricCondition(EAcquireMode mode)
        {
        ...
        public string ToWhere()
        {
            ...
            {
                this.where.AppendFormat(" and UserEmpiricRecord.CreateTime>='{0}' and UserEmpiricRecord.CreateTime<='{1}' ", this.StartTime, this.EndTime);
            }
