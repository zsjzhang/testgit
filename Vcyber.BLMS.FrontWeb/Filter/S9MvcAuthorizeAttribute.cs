...
namespace Vcyber.BLMS.FrontWeb
{
    ...
    public class S9MvcAuthorizeAttribute : AuthorizeAttribute
    {
        #region ==== 公共方法 ====
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            if (userIdentity.UserType != EnumExtension.GetDiscribe<EUserType>(EUserType.LF) && userIdentity.UserType != EnumExtension.GetDiscribe<EUserType>(EUserType.TOP))
            {
                return false;
            }
