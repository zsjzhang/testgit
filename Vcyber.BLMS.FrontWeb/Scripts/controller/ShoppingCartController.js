...
function Cookie() {
  ...
  　　@return void 
  　　*/
    this.setCookie = function (name, value, hours,secure) {
        var expire = "";
        if (hours !== null) {
        ...
        var path = ";path=/";
        document.cookie = escape(name) + "=" + escape(value) + expire + path + ((secure) ? "; secure" : "");
    };

    this.setCookieCenter = function (name, value, hours, secure) {
        var expire = "";
        if (hours !== null) {
