    ...
    obj.getLocation = function (callback) {
        ...
        wx.getLocation({
            success: function (res) {
                ...
                //popWindownBlue( common.format("经度：{0}，纬度：{1}，速度：{2}，位置经度：{3}", latitude, longitude, speed, accuracy));
            }, fail: function () {
                popWindownBlue( "获取位置信息失败，请检查是否已开启GPS定位且允许微信使用定位服务。");
            }
        });
    }
})(WeChat);